<div style="text-Align: 'center';  font-Family: 'Arial, sans-serif'; background-color: '#fafdfb'; padding: '20px' ">
      <img src="https://i.imgur.com/JAlqwlq.jpeg" alt="MyImage" style= "max-Width: '100%'; height: 'auto'; borderRadius: '10px'  " />
      ...
      <hr/>
      <h2 style="font-Size: '1.5em'; background: 'lightgray'; padding: '10px' ">Contact Me📩</h2>
      <p style="font-Size: '1.2em'; padding: '10px' ">You can reach me at:</p>
      <ul style="list-Style: 'none'; padding: 0; display: 'flex'; justify-Content: 'center'; flex-Wrap: 'wrap'; gap: '10px' ">
